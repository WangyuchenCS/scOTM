...
class scOTM(nn.Module):
    def __init__(self, input_dim=6998, latent_dim=200, hidden_dim=1000, 
        ...
        self.loss_type = loss_type  # 'kl', 'mmd', or 'wasserstein'
    ...
    def forward(self, x, perturbation, fm=None):
        ...
        if self.loss_type == 'kl':
            ...
            loss_match = kl(Normal(mu, std), Normal(0, 1)).sum(dim=1)
            ...
            raise ValueError("Unsupported loss_type. Choose from 'kl', 'mmd', or 'wasserstein'.")
